...
enum MiiversePalette {
    static let green = Color(red: 0.36, green: 0.78, blue: 0.11)
    static let greenDark = Color(red: 0.25, green: 0.62, blue: 0.08)
    static let greenLight = Color(red: 0.55, green: 0.90, blue: 0.27)
    static let paper = Color(red: 0.99, green: 0.99, blue: 0.97)
    static let shell = Color(red: 0.94, green: 0.95, blue: 0.91)
    static let line = Color(red: 0.84, green: 0.87, blue: 0.80)
    static let text = Color(red: 0.17, green: 0.20, blue: 0.15)
    static let secondaryText = Color(red: 0.45, green: 0.49, blue: 0.42)
...
struct MiiverseWallpaper: View {
    var body: some View {
        ZStack {
            LinearGradient(
                colors: [MiiversePalette.shell, Color.white],
                startPoint: .top,
                endPoint: .bottom
            )
            ...
            ForEach(items) { item in
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    RemoteImageView(
                        ...
                        scaling: scalingOverride ?? (item.prefersContainedScaling ? .fit : .fill),

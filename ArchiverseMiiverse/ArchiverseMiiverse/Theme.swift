    ...
    var body: some View {
        ZStack {
            ...
            ScrollView {
                ...
                .padding(.top, 16)
                .padding(.bottom, 24)
                .miiverseContentColumn(maxWidth: 980)
            }
        }
...
extension View {
    ...
    func miiverseContentColumn(maxWidth: CGFloat = 980) -> some View {
        modifier(MiiverseContentColumnModifier(maxWidth: maxWidth))
    }
}

private struct MiiverseContentColumnModifier: ViewModifier {

...
struct UserProfileView: View {
    ...
    private func loadModeData() async {
        ...
        do {
            ...
            case .posts:
                posts = []
                currentPostsPage = 1
                let fetchedPosts = try await api.fetchUserPosts(userID: userID, page: currentPostsPage)
                posts = fetchedPosts
    ...
    private func loadMorePosts() async {
        ...
        do {
            ...
            let fetchedPosts = try await api.fetchUserPosts(userID: userID, page: nextPage)
